...
def _paged_attention_decode_v2_with_dot_kernel_reshape_wrapper(
    ...
    if 0:
    # if 1:
        # ttgir_file_path = os.path.join(os.path.dirname(__file__), "./thread_trace/triton_gen_asm/pa_decode_v2_gluon_fp8/paged_attention_decode_v2_gluon_fp8.ttgir")
        # ttgir_file_path = os.path.join(os.path.dirname(__file__), "./thread_trace/triton_gen_asm/pa_decode_v2_gluon_fp8_tn3.5/paged_attention_decode_v2_gluon_fp8.ttgir")
        ttgir_file_path = os.path.join(os.path.dirname(__file__), "./paged_attention_decode_v2_gluon_fp8.ttgir")
